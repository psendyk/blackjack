...
###### Kinematics
For Baxter's movement we planned on primarily using inverse kinematics with the MoveIt package to perform motion planning for card manipulation. We also planned on adding constraints and objects within MoveIt, similar to how Lab 8 worked, to avoid hitting the table or the deck.
###### Computer Vision
