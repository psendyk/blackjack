...
#### Henry Leou
Henry is a fourth year majoring in Data Science and Applied Math. He has relevant experience from taking EE120, EE123, CS189/289A, and MATH 128A. Currently, he is helping on a research called Deep Truck under Prof.Bayen's PhD student in Mobile Sensing Lab. He is interested in deep learning, fast algorithms, and software engineering. He helped on writing scripts and design on for computer vision, specifically on deep learning for hand gesture and card recognition.
#### Pawel Sendyk   
